...
from pSCNAClonal.preprocess.converter import BamConverter
...
def process(args):
    ...
    '''
    print "run preprocess p-SCNAClonal"
    print "pklPath"
    print args.pklPath
    print "pklFlag"
    print args.pklFlag
    ...
    converter.convert(readFromBed = False, method = args.gcCorrectionMethod, pklFlag = args.pklFlag)
