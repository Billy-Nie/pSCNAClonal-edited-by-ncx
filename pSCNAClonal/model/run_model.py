...
from pSCNAClonal.model.joint_model import JointProbabilisticModel
from pSCNAClonal.model.utils import model_selection_by_ll
...
def get_summary(ll_lst, subclone_num_lst, run_time, output_filename_base):
    model_selection_filename = output_filename_base + '.pSCNAClonal.model_selection'
